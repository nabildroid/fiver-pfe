...
<form method="POST" class="container mx-auto px-4 py-8">
    <h1 class="text-2xl font-bold mb-8">New Program</h1>

    <div class="grid grid-cols-2 gap-6">
        <div class="col-span-2 md:col-span-1">
            <div class="bg-white p-6 rounded-md shadow-md">
                <div class="mb-4">
                    <label for="programName" class="block text-gray-700 font-medium mb-2">Program Name:</label>
                ...
                <div class="mb-4">
                    <label for="programType" class="block text-gray-700 font-medium mb-2">Program Type:</label>
                ...
                <div class="mb-4">
                    <label for="institutionName" class="block text-gray-700 font-medium mb-2">Institution Name:</label>
                ...
                <div class="mb-4">
                    <label for="internalOrExternal" class="block text-gray-700 font-medium mb-2">Internal or External:</label>
        ...
        <div class="col-span-2 md:col-span-1">
            <div class="bg-white p-6 rounded-md shadow-md">
                ...
                <div class="mb-4">
                    <label for="numberOfHours" class="block text-gray-700 font-medium mb-2">Number of Hours:</label>
                ...
                <div class="mb-4">
                    <label for="numberOfDays" class="block text-gray-700 font-medium mb-2">Number of Days:</label>
                ...
                <div class="mb-4">
                    <label for="trainer" class="block text-gray-700 font-medium mb-2">Trainer</label>
    ...
    <div class="flex justify-end mt-6">
        <button type="submit" class="bg-blue-500 text-white py-2 px-4 rounded-md">Save Program</button>
    </div>
</form>
</body>